...
Revision ID: 31a537f9c80e
Revises: 
Create Date: 2025-11-16 15:19:14.981080
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['create_uid'], ['users.id'], name=op.f('fk_users_create_uid_users'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['update_uid'], ['users.id'], name=op.f('fk_users_update_uid_users'), ondelete='RESTRICT'),
    ...
    sa.Column('created', sa.DateTime(), nullable=True),
    sa.Column('updated', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['create_uid'], ['users.id'], name=op.f('fk_groups_create_uid_users'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['update_uid'], ['users.id'], name=op.f('fk_groups_update_uid_users'), ondelete='RESTRICT'),
    ...
    sa.Column('created', sa.DateTime(), nullable=True),
    sa.Column('updated', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['create_uid'], ['users.id'], name=op.f('fk_groups_permissions_create_uid_users'), ondelete='RESTRICT'),
    ...
    sa.ForeignKeyConstraint(['update_uid'], ['users.id'], name=op.f('fk_groups_permissions_update_uid_users'), ondelete='RESTRICT'),
